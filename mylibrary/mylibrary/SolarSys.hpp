...
#define LOADERGLTF2 // for new version ; A problem exists with rendering only the first node

#ifdef LOADERGLTF2
#include <mylibrary/LoaderGLTF2.h> // new version
#else
...
#ifdef LOADERGLTF2
		LoaderGLTF2::glTFLoader* starModel{ nullptr };
#else
